...
(1,'johndoe', 'John', 'Doe', '$2y$10$DGKap6Q0riTiBDZRtXlTweawaTL13xrETE58we/zS3Y3YO.CfwLWW', 'john.doe1@example.com', 'user', 1),
(2,'jane_smith03', 'Jane', 'Smith', '$2y$10$57B48nW.J8tHWvbsfLYMZeLx0cccZ/XP1dQaXl88y8wmOq3C.Jqdq', 'jane.smith2@example.com', 'user', 2),
(3, 'mikyjohnson', 'Mike', 'Johnson', '$2y$10$QUeGWR7.mMiEdXICJSDXxOSyS397zvpcZa3iiNGTdmg0BB1V6yFCO', 'mike.johnson3@example.com', 'user', 3),
(4,'emy_dav', 'Emily', 'Davis', '$2y$10$t6Y0bgYgEIvVCI1gx4T.Vu6pRk5.fhkhYH/2NkV0YeZMlRDwh95w2', 'emily.davis4@example.com', 'user', 4),
(5, 'chris_brownie', 'Chris', 'Brown', '$2y$10$t6Y0bgYgEIvVCI1gx4T.Vu6pRk5.fhkhYH/2NkV0YeZMlRDwh95w2', 'chris.brown5@example.com', 'user', 5),
(6,'patty102', 'Pat', 'Taylor', '$2y$10$RUr.yhoeIH527vWUl77dauyMxC24FihUcLA.N1/4M4wLr0.jHm26u', 'pat.taylor6@example.com', 'user', 6),
(7, 'alexxx_andy', 'Alex', 'Anderson', '$2y$10$9ielRaoMg9CHeRei78kWtuvtMu3TzBS7P/CH1tMayzBPKWS5/cO62', 'alex.anderson7@example.com', 'user', 7),
(8,'sam_thomas_112', 'Sam', 'Thomas', '$2y$10$QZrXIwspfPMttrTkP2Z0o.rl8lPqCCyMLn.J91O29upX4z3CH9sfC', 'sam.thomas8@example.com', 'user', 8),
(9,'_casey_12', 'Casey', 'Lee', '$2y$10$wjiGxsM1ZQLlMks3.n5yoOPxm7Q.G2cBbh1ovG58RKxvbc/yQaS8.', 'casey.lee9@example.com', 'user', 9),
(10,'jordy_harris194', 'Jordan', 'Harris', '$2y$10$mgNR6OvBqtkq6a07fZ6qiucVHu2160EU6ntbvIrLI8zRAu0S6fPeS', 'jordan.harris10@example.com', 'user', 10);
